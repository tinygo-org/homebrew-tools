class Tinygo < Formula
    ...
    on_macos do
        on_arm do
            ...
            sha256 "6e116cb29ce9a3387783186d7067280f08577abeba47360bdc85770f669848ce"
        end
        on_intel do
            url "https://github.com/tinygo-org/tinygo/releases/download/v#{version}/tinygo#{version}.darwin-amd64.tar.gz"
            sha256 "b4c8263185929c211f48ddbe00c155c1ea899857a2f231289d880a700bfa2264"
        end
    end
    on_linux do
        url "https://github.com/tinygo-org/tinygo/releases/download/v#{version}/tinygo#{version}.linux-amd64.tar.gz"
        sha256 "a529eff745a9ecb78f0c086492ddc2645a53e0a37fa99e750d2d0a785a42ba91"
    end
